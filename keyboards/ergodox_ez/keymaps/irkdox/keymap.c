...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_GRAVE,       KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,           TD(DANCE_1),                                    TD(DANCE_4),    KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_PERC,        KC_CIRC,        KC_LPRN,        KC_RPRN,        KC_TILD,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_ASTR,        KC_KP_1,        KC_2,           KC_3,           KC_MINUS,       KC_TRANSPARENT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    LALT(KC_F),     KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                                           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_5),
    KC_TAB,         KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       KC_EQUAL,                                       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    KC_LSHIFT,      KC_TRANSPARENT, KC_A,           KC_S,           KC_D,           KC_C,           KC_LSHIFT,                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,       TO(0),          KC_GRAVE,
